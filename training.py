...
Cpredict_active = pd.read_csv()
Cpredict_total =pd.read_csv()
Clabel_active =pd.read_csv()
Clable_total =pd.read_csv()
...
scores = (Cpredict_active / Cpredict_total) / (Clabel_active / Clable_total)